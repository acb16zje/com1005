/**
 * Search.java - abstract class specialising to JugsSearch etc includes depth-first, breadth first
 * strategies reconstructs solution path 2013 version
 */
...
public abstract class Search {
    ...
    public String runSearch(SearchState initState, String strat) {
        ...
        while (!open.isEmpty()) {
            ...
            scr.println("=========================== \n");
            scr.println("Iteration number: " + cnum);
            if (cnum <= 150) {
                scr.println("The open nodes are");
            ...
            if (currentNode.goalP(this)) {
                return reportSuccess(cnum);  //success
            }
    ...
    private String reportSuccess(int cnum) {
        ...
        scr.println("Total number of iterations: " + cnum);

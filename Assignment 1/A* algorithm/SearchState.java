/**
 * State in a state-space search abstract class must implement goalP, getSuccessors, sameState,
 * toString variable cost version - has localCost variable A* version - has estRemCost changes
 * indicated by //A*- 2013 version
 */

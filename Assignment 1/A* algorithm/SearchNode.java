/**
 * Node in a state-space search variable costs case Must implement goalP, getSuccessors, sameState,
 * node_toString node has local cost & global cost now This version for A* Mods indicated by //A*
 * 2013 version
 */
...
public class SearchNode {
    ...
    public String toString() {
        ...
        return "\n======Start of Node======\nParent(previous state): " + parent_state
            + "\nState(current): " + state.toString() + "Local cost:          " + localCost
            + "\nGlobal cost:         " + globalCost + "\nEst. remaining cost: " + estRemCost
            + "\nEst. total cost:     " + estTotalCost + "\n=======End of Node=======";
    }
